...
| **4** | wrist_roll | 末端旋转（真机实测） | -90° ~ 90° | **5** |
| **5** | wrist_flex | 末端上下（真机实测） | 0° ~ 90° | **6** |
| **6** | gripper | 末端旋转（真机实测） | 0° ~ 360° | **7** |

> **✅ 命名统一（2026-08-19）**：J4=腕翻转(roll)、J5=腕俯仰(flex) 已与真机实测对齐，
> 旧标注（J4 wrist_flex / J5 wrist_roll）全仓修正。J4 与 J6 为末端旋转运动、J5 为末端上下运动。
