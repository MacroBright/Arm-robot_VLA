...
echo ""
echo "  # 终端2: 评估 (先跑3集带诊断日志)"
echo "  sleep 3 && HF_HUB_OFFLINE=1 python scripts/evaluate_policy.py --episodes 3 --debug"
echo ""
echo "  # 确认正常后跑完整评估:"
echo "  HF_HUB_OFFLINE=1 python scripts/evaluate_policy.py --episodes 30"
