...
from arm_robot.driver.can_transport import CanTransport
...
from arm_robot.driver.scan import scan_via_driver
from arm_robot.driver.zdt_driver import (
...
class ZdtController:
    ...
    def _drive_rel(self, joint_idx: int, delta_deg: float,
        ...
        if speed_rpm is None:
            ...
            spd = max(30.0, min(float(self.config.speed_rpm), needed_rpm * 1.25))
        else:
            spd = speed_rpm
