...
from arm_robot.teleop.arm_adapter import RealArmAdapter, SimulationArmAdapter  # noqa: E402
...
def test_real_adapter_does_not_touch_driver_directly():
    ...
    import arm_robot.teleop.arm_adapter as mod
...
def test_no_drive_adapter_lifecycle():
    from arm_robot.teleop.arm_adapter import NoDriveArmAdapter
    a = NoDriveArmAdapter()
    ...
    a.ready()
    assert list(a.get_joint_state().q) == a.ready_pose
    a.home()
